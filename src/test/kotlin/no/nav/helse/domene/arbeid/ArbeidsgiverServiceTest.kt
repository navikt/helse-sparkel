...
class ArbeidsgiverServiceTest {
    ...
    fun `skal returnere en liste over organisasjoner`() {
        ...
        val expected = listOf(
                no.nav.helse.domene.organisasjon.domain.Organisasjon.Virksomhet(Organisasjonsnummer(arbeidsgiver_organisasjon_1.orgnummer),
                        arbeidsgiver_organisasjon_1.navn),
                no.nav.helse.domene.organisasjon.domain.Organisasjon.Virksomhet(Organisasjonsnummer(arbeidsgiver_organisasjon_2.orgnummer),
    ...
    fun `skal slå opp navn på organisasjon`() {
        ...
        val expected = listOf(
                no.nav.helse.domene.organisasjon.domain.Organisasjon.Virksomhet(Organisasjonsnummer(arbeidsgiver_organisasjon_3.orgnummer),
        ...
        } returns Either.Right(no.nav.helse.domene.organisasjon.domain.Organisasjon.Virksomhet(Organisasjonsnummer(arbeidsgiver_organisasjon_3.orgnummer),
                arbeidsgiver_organisasjon_3_navn))
    ...
    fun `skal returnere tomt organisasjonnavn når oppslag av organisasjonnavn feiler`() {
        ...
        val expected = listOf(
                no.nav.helse.domene.organisasjon.domain.Organisasjon.Virksomhet(Organisasjonsnummer(arbeidsgiver_organisasjon_3.orgnummer), null)
        )
